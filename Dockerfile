...
from nginx
copy --from=build-step /app/images/ /usr/share/nginx/html
copy --from=build-step /app/css/ /usr/share/nginx/html
copy --from=build-step /app/fonts/ /usr/share/nginx/html
copy --from=build-step /app/js/ /usr/share/nginx/html
